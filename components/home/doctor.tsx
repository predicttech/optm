    ...
    return (
        <section className="relative py-20 m-3">
            <div className="relative mx-auto flex max-w-5xl flex-col h-full space-y-6">
                ...
                <div className="max-w-md md:max-w-3xl">
                    <h1
                        ...
                        The Man Behind <br/> 34+ years of Research  
                    </h1>
                    <p className="mt-6 text-sm leading-6 text-black/60">
                    
                    Pain, metabolism, movement, and plant medicine. Every patient protocol is designed by all of them together. No siloed treatment.
                    </p>
            ...
            <div className="grid gap-3 md:gap-6 md:grid-cols-2 mx-auto max-w-5xl">
                    ...
                    >
                        ...
                        >
                            <h1 className="text-xl md:text-3xl text-white/80">
                                "I didn't want to build another pain clinic. I wanted to build
                                the one thing that was missing - proof."
                            </h1>
                ...
                <div className="group relative h-140 overflow-hidden rounded-3xl border border-[#D5BBEA] bg-black">
                    <div className="p-10 space-y-4 flex flex-wrap gap-3">

                        <h1 className="text-xl md:text-3xl text-white/80">
                            Dr. Ganguly has spent 34 years researching the biological
                            drivers of chronic musculoskeletal pain.

                        </h1>
                        <p className="text-sm text-white/60">
                            His work on biomarker- led diagnosis  including the Bio-Musculo Index™ and MuscleAGE™ is published in NIH-indexed, peer-reviewed journals and forms the clinical foundation for every protocol at optm.
                        </p>
                        ...
                        <div className="flex justify-between w-full items-center gap-6 mt-4 text-sm">
